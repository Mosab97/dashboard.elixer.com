<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 my-7">
        <form id="kt_modal_change_status_form" class="form"
            ...
            action="{{ route($config['full_route_name'] . '.update_status', ['_model' => $_model->id]) }}">
            @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="fv-row mb-4">
                        ...
                        <select class="form-select form-select-solid validate-required" name="status" id="status"
                            ...
                            @foreach ($status_list ?? [] as $status)
                                <option value="{{ $status->value }}" @selected(isset($_model) && $_model->status == $status)>
                                    {{ $status->getLabel() }}
                                </option>
                            @endforeach
                        </select>
