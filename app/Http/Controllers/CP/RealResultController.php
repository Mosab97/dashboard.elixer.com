...
class RealResultController extends Controller
{
    ...
    public function __construct(
        RealResult $_model,
        RealResultFilterService $filterService,
    ) {
        $this->config = config('modules.real_results');
        $this->_model = $_model;
    ...
    public function edit(Request $request, RealResult $_model)
    {
    ...
    public function addedit(RealResultRequest $request)
    {
    ...
    public function delete(Request $request, RealResult $_model)
    {
        try {
            DB::beginTransaction();
