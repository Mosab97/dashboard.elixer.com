...
use App\Http\Requests\CP\AddressRequest;
use App\Models\Address;
use App\Services\Filters\AddressFilterService;
...
class AddressController extends Controller
{
    ...
    public function __construct(
        Address $_model,
        AddressFilterService $filterService,
    ) {
        $this->config = config('modules.addresses');
        $this->_model = $_model;
    ...
    public function edit(Request $request, Address $_model)
    {
    ...
    public function delete(Request $request, Address $_model)
    {
        try {
            DB::beginTransaction();
